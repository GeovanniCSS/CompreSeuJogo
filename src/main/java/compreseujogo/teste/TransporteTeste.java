...
public class TransporteTeste {
	...
	public static void main(String[] args) {
		...
		Transporte transporte = new Transporte(0, "Sedex", "28.833.271/0001-47", "sedex@gmail.com",
				"Jardinete Kosop", "81230-105", "PR", "(41) 95445-9458", "sedex", "sdadad", "asdadadad", true,5);
		try {
